...
export default function Projects () {
  ...
  const projects = [
    ...
    {
      title: "Bibliophile",
      description: "Progetto per il corso JavaScript Advanced di Start2impact University",
      imgUrl: projImg1,
  ...
  return (
    <section className="projects" id="projects">
      <h2>Progetti</h2>
      <p>Questa è una raccolta dei progetti che ho sviluppato dall'inizio del mio percorso di studi ad oggi. Cliccando sul progetto di tuo interesse potrai curiosare nel codice (nella repository di GitHub) e troverai anche il file Read Me, completo di link per vedere il risultato finale.</p>
